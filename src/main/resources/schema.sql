...
insert into CUSTOMER(CUSTOMER_TYPE, CUSTOMER_NAME, CUSTOMER_ADDRESS) values(COMPANY, FDM,1);
insert into CUSTOMER(CUSTOMER_TYPE, CUSTOMER_NAME, CUSTOMER_ADDRESS) values(PERSON, JOHN,2);
